...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-[#25D366] shadow-[0_0_15px_rgba(37,211,102,0.5)]">
          {/* WhatsApp Icon */}
        ...
        <span className="text-[14px] font-semibold text-white tracking-wide">Chat with us</span>
      </motion.a>
    </motion.div>
  );
}
